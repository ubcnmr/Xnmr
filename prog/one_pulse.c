...
int main()
{
  ...
  do {
    ...
    time = pulse_padding / 1000000;
    event( time, 2, BNC_3, 1, PHASE, (get_acqn() %4) );   //This should latch the phase output

    time = pulse_time / 1000000;
    event( time, 3, BNC_0, 1, BNC_3, 1, PHASE, (get_acqn() %4) );           //the pulse
